...
## Overview
This project is a 25 + 5 Clock built using React, Bootstrap, and other modern web technologies. The application serves as a Pomodoro timer, allowing users to set session and break lengths, start/stop the timer, and reset the timer to default values.

## Features
- Set break and session lengths
- Start, stop, and reset the timer
- Countdown displays in mm:ss format
- Alerts for session and break transitions
